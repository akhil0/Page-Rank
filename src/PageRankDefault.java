...
public class PageRankDefault {
	...
	public static void main(String[] args) throws Exception {
		String winlink = "";
		String filePath = "C:\\Users\\AKI\\workspace\\PageRank\\wt2g_inlinks.txt";
		try {
		...
		int id0 = 0;
		File log = new File("C:\\Users\\AKI\\workspace\\PageRank\\prwt2g.txt");
